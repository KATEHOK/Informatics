...
def editor(one, two):
    correctStr = '1' * one + '2' * two
    print(correctStr)
    while '111' in correctStr:
        correctStr = correctStr.replace('111', '2')
        if '222' in correctStr:
            correctStr = correctStr.replace('222', '1')
    return correctStr


print(editor(2018, 2019))  # 2
